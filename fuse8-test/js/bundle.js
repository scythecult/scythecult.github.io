...
/***/ "./source/js/index/components/search.js":
/*!**********************************************!*\
  !*** ./source/js/index/components/search.js ***!
  \**********************************************/
...
var search = function search(targetContainer) {
  ...
  var onSearchKeyup = function onSearchKeyup(evt) {
    var searchTerm = evt.target.value.toLowerCase().trim();
    findElement(searchTerm, targetElements);
  };

  form.addEventListener("keyup", onSearchKeyup);
};
...
/* harmony import */ var _components_search__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/search */ "./source/js/index/components/search.js");
...
response.then(handleResponse).then(function (houseData) {
  ...
  return Object(_components_search__WEBPACK_IMPORTED_MODULE_1__["search"])(houseList);
});
...
/***/ 0:
/*!*************************************************************************************************************************!*\
  !*** multi ./source/js/index/main.js ./source/js/index/components/house-card.js ./source/js/index/components/search.js ***!
  \*************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! D:\_webdev\_test-tasks\projects\fuse8\source\js\index\main.js */"./source/js/index/main.js");
__webpack_require__(/*! D:\_webdev\_test-tasks\projects\fuse8\source\js\index\components\house-card.js */"./source/js/index/components/house-card.js");
module.exports = __webpack_require__(/*! D:\_webdev\_test-tasks\projects\fuse8\source\js\index\components\search.js */"./source/js/index/components/search.js");
